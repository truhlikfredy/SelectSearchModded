...
function getLocal(txt) {
	if (localStorage[txt] == null) {
		return (is_default(txt))
	};
...
function tr(text) {
	switch (getLang()) {
		case 'fr':
			switch (text) {
				case "Google search: <<text>>":
					return "Chercher <<text>> avec Google."
				case 'Google Image search: <<text>>':
					return "Chercher avec Google image : <<text>>"
				case 'Wikipedia search: <<text>>':
					return "Chercher <<text>> sur Wikipedia."
				case 'Twitter search: <<text>>':
					return "Chercher <<text>> sur Twitter."
				case 'Search on Ebay: <<text>>':
					return "Chercher <<text>> sur Ebay."
				case 'Search on Google Maps: <<text>>':
					return "Chercher <<text>> dans Google Maps."
				case 'Search on Youtube: <<text>>':
					return "Chercher <<text>> sur Youtube."
				case 'Search on Geograph: <<text>>':
					return "Chercher <<text>> sur Geograph."
				case 'Search with Flickr: <<text>>':
					return "Chercher <<text>> sur Flickr."
				case 'Search with Nzbindex.nl: <<text>>':
					return "Chercher <<text>> avec Nzbindex.nl."
			}
		case 'de':
			switch (text) {
				case "Google search: <<text>>":
					return "Suche auf Google <<text>>"
				case 'Google Image search: <<text>>':
					return "Suche auf Google Images <<text>>"
				case 'Wikipedia search: <<text>>':
					return "Suche auf Wikipedia<<text>>"
				case 'Twitter search: <<text>>':
					return "Suche auf Twitter <<text>>"
				case 'Search on Ebay: <<text>>':
					return "Suche auf Ebay <<text>>"
				case 'Search on Google Maps: <<text>>':
					return "Suche auf Google Maps <<text>>"
				case 'Search on Youtube: <<text>>':
					return "Suche auf Youtube <<text>>"
				case 'Search on Geograph: <<text>>':
					return "Suche auf Geograph <<text>>"
				case 'Search with Flickr: <<text>>':
					return "Suche auf Flickr <<text>>"
			}
		case 'nl':
			switch (text) {
				case "Google search: <<text>>":
					return "Zoeken op Google narr <<text>>"
				case 'Google Image search: <<text>>':
					return "Zoeken op Google Afbeeldingen narr <<text>>"
				case 'Wikipedia search: <<text>>':
					return "Zoeken op Wikipedia narr <<text>>"
				case 'Twitter search: <<text>>':
					return "Zoeken op Twitter narr <<text>>"
				case 'Search on Ebay: <<text>>':
					return "Zoeken op Ebay narr <<text>>"
				case 'Search on Google Maps: <<text>>':
					return "Zoeken op Google Maps narr <<text>>"
				case 'Search on Youtube: <<text>>':
					return "Zoeken op Youtube narr <<text>>"
				case 'Search on Geograph: <<text>>':
					return "Zoeken op Geograph narr <<text>>"
				case 'Search with Flickr: <<text>>':
					return "Zoeken op Flickr narr <<text>>"
			}
		case 'es':
			switch (text) {
				case "Google search: <<text>>":
					return "Búsqueda en Google <<text>>"
				case 'Google Image search: <<text>>':
					return "Búsqueda en Google Imágenes <<text>>"
				case 'Wikipedia search: <<text>>':
					return "Búsqueda en Wikipedia <<text>>"
				case 'Twitter search: <<text>>':
					return "Búsqueda en Twitter <<text>>"
				case 'Search on Ebay: <<text>>':
					return "Búsqueda en Ebay <<text>>"
				case 'Search on Google Maps: <<text>>':
					return "Búsqueda en Google Maps <<text>>"
				case 'Search on Youtube: <<text>>':
					return "Búsqueda en Youtube <<text>>"
				case 'Search on Geograph: <<text>>':
					return "Búsqueda en Geograph <<text>>"
				case 'Search with Flickr: <<text>>':
					return "Búsqueda en Flickr <<text>>"
			}
		case 'ru':
			switch (text) {
				case "Google search: <<text>>":
					return "поиск в Google <<text>>"
				case 'Google Image search: <<text>>':
					return "поиск в Google Images <<text>>"
				case 'Wikipedia search: <<text>>':
					return "поиск в Wikipedia <<text>>"
				case 'Twitter search: <<text>>':
					return "поиск в Twitter <<text>>"
				case 'Search on Ebay: <<text>>':
					return "поиск в Ebay <<text>>"
				case 'Search on Google Maps: <<text>>':
					return "поиск в Google Maps <<text>>"
				case 'Search on Youtube: <<text>>':
					return "поиск в Youtube <<text>>"
				case 'Search on Geograph: <<text>>':
					return "поиск в Geograph <<text>>"
				case 'Search with Flickr: <<text>>':
					return "поиск в Flickr <<text>>"
			}
